...
import { IconButton, Text, useTooltip } from '@pancakeswap/uikit'
...
const mobileShowOnceTokenHighlightAtom = atomWithStorage('pcs::mobileShowOnceTokenHighlightV2', true)
...
const CurrencyInputHeader: React.FC<React.PropsWithChildren<Props>> = memo(
  ({ subtitle, title, hasAmount, onRefreshPrice }) => {
    ...
    return <>currencyInputHeader (TEST)</>
